...
% 2. Show that P_k is nonempty
% 3. Show that P^_{k + 1} is non-empty
% 4. Show that all edges in D_k are legit in G
% 5. Show that all outgoing edges of P_k are in D_k
% 6. Induction
