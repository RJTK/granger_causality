...
\begin{figure}
  ...
  \includegraphics[width=0.95\textwidth]{new_lasso_comparison_scg_simulation.pdf}
...
\begin{figure}
  ...
  \includegraphics[width=0.95\textwidth]{new_lasso_comparison_dag_simulation.pdf}
